function [x_shift, y_shift, orientation, semiminor_axis, psf_variance, height, aspect_ratio_minus_one, equatoriality, residual] = fit_ellipsoid_lsqcurvefit(x_shift, y_shift, orientation, semiminor_axis, psf_variance, height, aspect_ratio_minus_one, equatoriality, actual_image, fluorophores,~)
...
listI = actual_image(:); % List of pixel values in actual image
